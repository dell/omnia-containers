...
#   rollback            - Rollback omnia.sh and verify
...
#   upgrade_and_rollback - upgrade → rollback
#
# Examples:
...
#   ./run_molecule.sh rollback verify              # Verify rollback
#
# =============================================================================
