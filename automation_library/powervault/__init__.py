...
"""
PowerVault iSCSI Storage Automation Module

This module provides functions for PowerVault ME4/ME5 iSCSI storage
configuration validation. Uses core module utilities for SSH,
PXE mapping, and config reading.

Test Categories:
- iSCSI Infrastructure: iscsid, initiator, discovery, sessions, startup
- Multipath: multipathd, device matching, path redundancy
- Partition/Mount: GPT, filesystem, mount point, fstab
- Bind Mounts: node subdirectories, bind targets, fstab, isolation
- Functional Groups: targeting, multi-prefix
- I/O: write/read, bind I/O
- Cloud-Init: setup log, groups dict
- Error Handling: duplicate fstab
"""
