...
This module contains shared/common messages used across telemetry modules.
For Kafka-specific messages, see kafka_msgs.py.
For iDRAC telemetry-specific messages, see idrac_telemetry_msgs.py.
"""
