...
"""
Build Stream Automation - Shared Functions (v2.1).
...
def get_build_stream_port(host) -> int:
    ...
    return get_input_value(host, BUILD_STREAM_CONFIG_FILE, BUILD_STREAM_PORT_KEY, default=8010)
...
def get_catalog_name(host) -> str:
    ...
    pipeline. The catalog file must exist in the /omnia/examples/catalog/
    directory inside the omnia_core container.
    ...
    Returns:
        Catalog filename string (e.g., 'catalog_rhel_x86_64_with_slurm_only.json').
    """
    import yaml
    import os
