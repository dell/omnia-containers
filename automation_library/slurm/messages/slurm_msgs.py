...
CUSTOM_SLURM_NEGATIVE_PASSED = "Negative test passed: custom config mismatch correctly detected"
CUSTOM_SLURM_NEGATIVE_FAILED = "Negative test failed: expected mismatch was not detected"
CUSTOM_SLURM_UNEXPECTED_MATCH = "Negative test failed: expected mismatch for {key} but values matched (expected: {expected}, actual: {actual})"
