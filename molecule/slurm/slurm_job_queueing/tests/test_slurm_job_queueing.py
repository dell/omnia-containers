...
Usage:
    ./run_molecule.sh slurm/slurm_job_queueing test      # Run playbook + verify
    ./run_molecule.sh slurm/slurm_job_queueing verify    # Verify only
"""

import pytest
from automation_library.core import TestLogger
from automation_library.slurm.vars.slurm_job_queueing_vars import (
    SLURM_JOB_QUEUEING_VARS,
    PENDING_REASONS,
    JOB_STATES,
)
from automation_library.slurm.messages.slurm_job_queueing_msgs import (
    TEST_VARS, TEST_NAMES, TEST_LOG_MSGS as LOG_MSGS, TEST_ASSERT_MSGS as ASSERT_MSGS
)
from automation_library.slurm.functions.slurm_job_queueing_func import (
    submit_slurm_job,
...
def test_node_status(slurm_host):
...
def test_job_submission(slurm_host):
...
def test_job_pending_state(slurm_host):
...
def test_scheduler_allocation(slurm_host):
    ...
    submit_result = submit_slurm_job(slurm_host, job_name="scheduler_test")
