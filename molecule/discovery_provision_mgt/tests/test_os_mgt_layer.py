...
def test_os_name_and_version_mgt_layer(compute_nodes, oim_connection_details):
...
def test_domain_name_mgt_layer(compute_nodes, oim_connection_details, provisioned_domain_name):
...
def test_hostname_mgt_layer(compute_nodes, oim_connection_details):
