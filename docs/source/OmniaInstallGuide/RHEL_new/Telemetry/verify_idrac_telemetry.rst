...
3. To view the list of iDRAC Kafka topics configured, use the following command::
...
For example, the following "PowerEdge_TemperatureReading" query displays all available metrics:
