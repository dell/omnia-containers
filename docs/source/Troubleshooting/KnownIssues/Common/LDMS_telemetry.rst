...
5. Allow 2–5 minutes for the store daemon to reconnect to the aggregator and begin processing metrics from the new nodes.

   To check the store daemon logs, run the following command:
