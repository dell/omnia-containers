...
To deploy the container images from any Omnia branch, available at `Omnia Artifactory Repository <https://github.com/dell/omnia-containers.git>`_, do the following:
 ...
 1. Clone the Omnia artifacts repository and build the ``omnia_core`` container images. Run the following commands:
    ...
    .. code-block:: bash
      ...
      git clone https://github.com/dell/omnia-containers.git -b omnia-container-v2.1.0.0
      cd omnia-containers
      ./build_images.sh core omnia_branch=v2.1.0.0 core_tag=2.1 

  * For detailed build instructions, refer to the `Omnia Artifacts README <https://github.com/dell/omnia-containers/blob/omnia-container/README.md>`_.
