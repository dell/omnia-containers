...
* If the repository is hosted, use the URL created in the ``local_repo_config.yml`` file.
  ...
  user_repo_url_x86_64::
    ...
    - { url: "http://<ipaddress>/slurm-repo/x86_64", gpgkey: "", sslcacert: "", sslclientkey: "", sslclientcert: "", name: "x86_64_slurm_custom" }

  user_repo_url_aarch64::

    - { url: "http://<ipaddress>/slurm-repo/aarch64", gpgkey: "", sslcacert: "", sslclientkey: "", sslclientcert: "", name: "aarch64_slurm_custom" }
