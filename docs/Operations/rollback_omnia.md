...
!!! important
    ...
    **Use the Omnia 2.2.0.0-rc1 `omnia.sh` script for rollback operations.**
    The `omnia.sh` script from Omnia 2.1.0.0 does not support correct rollback
    operations. You must download and use the Omnia 2.2.0.0-rc1 version of
...
2. Download the Omnia 2.2.0.0-rc1 `omnia.sh` script from the Omnia repository:
