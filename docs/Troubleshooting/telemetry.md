...
??? note "Resolution"
    ...
    For Kafka PV sizing guidance based on telemetry sources and node count, see [Kafka PV Sizing Guidance](../../HowTo/Telemetry/setup_telemetry.md#kafka-pv-sizing-guidance).
