...
|---|---|
| OIM operating system | RHEL 10.0 for the documented validated RC1 baseline; see the [Operating Systems Matrix](../../Reference/SupportMatrix/operating_systems.md) |
