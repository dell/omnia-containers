...
| ☐ | RHEL 10.0 with Server with GUI Base Environment | Minimal installs are not supported. The GUI group pulls in required libraries used by Ansible and Podman. See [supported operating systems](https://omnia.readthedocs.io/en/v2.2.0.0/Overview/SupportMatrix/OperatingSystems/index.html). |
