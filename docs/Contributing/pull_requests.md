...
1. **Check existing issues and PRs.** Search the `GitHub issues
...
- **Documentation:** Follow the conventions in the existing documentation
...
pull requests. All contributions have to be certified using the [Developer Certificate of Origin (DCO)](https://developercertificate.org/)
...
3. **Fill out the PR description** using this template:
   ...
   ```text title="Example: PR description template"
   ## Summary
