...
| `oim_bmc_ips` | Optional | Mapping of OIM identifiers, such as `oim1`, to their BMC IP addresses when OIM server telemetry must be collected. Empty values are ignored. |
