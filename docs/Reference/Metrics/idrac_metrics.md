...
!!! note
    ...
    Some iDRAC telemetry metrics are not available on all server platforms. For example, PowerEdge XE8712 servers with NVIDIA GB200 accelerators support a limited set of iDRAC telemetry metrics. For details, see [Known Limitations: Limited iDRAC Telemetry Metrics for PowerEdge XE8712](../../Troubleshooting/known_limitations.md#limited-idrac-telemetry-metrics-for-poweredge-xe8712).
